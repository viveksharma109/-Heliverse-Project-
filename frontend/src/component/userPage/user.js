...
function UserPage() {
    ...
    const [userfind, setUserfind] = React.useState("");// ID FOR FIND
   ...
   // FOR CREATE OPEN
    ...
    const handleFindClick = async () => {
        try {
            ...
            const response = await axios.get(`${host_url}users/${userId}`);
            const foundUser = response.data;

            if (foundUser) {
                if (foundUser.error) {
                    console.log('Error:', foundUser.error);
                } else {
                    setUsers([foundUser]);
                    setUserfind("");
                }
    ...
    return (
        <>
            ...
            <Grid container spacing={2} columns={16}>
                <Grid item xs={8} >
                    <Item style={{ boxShadow: "none", textAlign: "left" ,}}>
                        <input onChange={HandleFindUser} type="text" placeholder="Search user" name="userfind" value={userfind} style={{ textAlign: "left", marginRight: "1rem", height: "26px", marginTop: "15px", marginLeft: "8px" }} />
                        <Button onClick={handleFindClick} sx={{my:3}} variant="contained">Search user</Button>
                    </Item>
                </Grid>
                <Grid item xs={8}>
              ...
              {/* DROPDOWN FOR DOMAIN*/}
            <Grid item xs={8}>
                <Item style={{ boxShadow: "none", display: 'flex', alignItems: 'center' }}>
                    <label htmlFor="id" style={{ fontFamily: "serif", height: "25px", marginRight: '25px', marginLeft: '8px', fontSize: "1rem", }}>Filter by Domain:</label>
            ...
            <Grid item xs={8}>
                <Item style={{ boxShadow: "none", display: 'flex', alignItems: 'center' }}>
                    <label htmlFor="id" style={{ fontFamily: "serif", height: "25px", marginRight: '30px', marginLeft: '8px', fontSize: "1rem", }}>Filter by Gender:</label>
                    <FormControl sx={{ m: 1, minWidth: 120 }}>
            ...
            <Grid item xs={8}>
                <Item style={{ boxShadow: "none", display: 'flex', alignItems: 'center' }}>
                    <label htmlFor="id" style={{ fontFamily: "serif", height: "25px", marginRight: '1px', marginLeft: '8px', fontSize: "1rem", }}>Filter by Availabelity:</label>
                    <FormControl sx={{ m: 1, minWidth: 120 }}>
            ...
            <Container style={{marginTop:"2rem", border: "1px solid #ccc", padding: "20px" }}>
            <Item style={{ boxShadow: "none", textAlign: "center" ,marginBottom:"8px"}}>
            ...
            {/* BUTTON FOR TEAM PAGE*/}
             <Grid item xs={8}>
                <Item style={{ boxShadow: "none", textAlign: "right",marginLeft:"17px"}}>
            ...
            <hr></hr>
              ...
              {/* USER IN CARD FORMAT*/}
            <Container style={{marginTop:"2rem",marginLeft:"2px"}}>
                <Grid container spacing={2}>
